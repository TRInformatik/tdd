...
public class TestService {
	...
	public void testCreateVeranstaltung() throws ParseException{
		v = service.createVeranstaltung("Weihnachtsmarkt", "20.12.2017 18:00", 0.0, 10);
		assertNotNull(v);
	...
	public void testStoreVeranstaltung() throws ParseException{
		service.storeVeranstaltung(new Veranstaltung("Weihnachtsmarkt", "20.12.2017 18:00", 0.0, 10));
	}
	
	@Test
	public void testGetFreeSeats() throws Exception{
		Veranstaltung v2 = service.createVeranstaltung("Weihnachtsmarkt 2", "22.12.2017 19:00", 0.0, 15);
		k = new Kunde("Mustermann Mayer", "Musterstraße 1, 39878 Musterstadt");
		Buchung b = new Buchung(k.getName(), v2.getID(), 5);
	...
	public void testCheckSeats() throws Exception{
		Veranstaltung v3 = service.createVeranstaltung("Silversterparty", "31.12.2016 19:00", 0.0, 30);
		Kunde k2 = new Kunde("Marko Mustermann", "Musterstraße 5, 39878 Musterstadt");
		Buchung b = new Buchung(k2.getName(), v3.getID(), 35);
	...
	public void testBooking() throws Exception{
		v = service.createVeranstaltung("Weihnachtsmarkt", "20.12.2017 18:00", 0.0, 10);
		k = new Kunde("Mustermann Mayer", "Musterstraße 1, 39878 Musterstadt");
		Buchung b = new Buchung(k.getName(), v.getID(), 5);
		service.book(b);
	}
